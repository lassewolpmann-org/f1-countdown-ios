...
struct RaceData: Decodable, Identifiable, Hashable {
    ...
    var tbc: Bool?
    var sessions: [String: String] = ["fp1": ISO8601DateFormatter().string(from: Date().addingTimeInterval(5)), "sprintQualifying": calcFutureDate(days: 7), "sprint": calcFutureDate(days: 8), "qualifying": calcFutureDate(days: 9), "gp": calcFutureDate(days: 10)]
